...
<body>
  ...
  <table width="100%">
    ...
    <tr>
      ...
      <td width="1%">:</td>
      <td><?= $dataOpd['alamat_instansi'] . " Telp. " . $dataOpd['no_telp'] . " Kode Pos " . $dataOpd['kd_pos']; ?>
      </td>
    </tr>
  </table>
  <?php
  ...
  ?>
  <p align="justify">Harap dikeluarkan barang dari gudang/tempat penyimpanan barang dan disalurkan barang tersebut untuk <?= $dataJab['jabatan']; ?>, sebagaimana daftar dibawah ini :</p>
