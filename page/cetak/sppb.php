...
<body>
  ...
  <h5 class="b"><u>SURAT PERINTAH PENYALURAN BARANG (SPPB)</u></h5>
  <?php 
  ...
  <table width="100%">
    <tr>
      ...
      <td width="1%">:</td>
      <td>Surat Permintaan Barang (SPB) Nomor <?= "0" . $dataSpb['no_spb'] . " / SPB / " . BulanRomawi($dataSpb['tanggal_spb']); ?> Tanggal <?= TanggalIndo($dataSpb['tanggal_spb']); ?></td>
    </tr>
    <tr>
      <td></td>
      <td></td>
  ...
  ?>
  <p align="left">Harap dikeluarkan barang dari gudang/tempat penyimpanan barang dan disalurkan barang tersebut untuk <?= $dataJab['jabatan']; ?> Kec. Gajah, sebagaimana daftar dibawah ini :</p>
...
//Membuat output file
$content = $mpdf->OutputHttpInline("SPPB.pdf", "I");
